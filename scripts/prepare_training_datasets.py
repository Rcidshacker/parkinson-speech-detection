...
def main():
    ...
    for feature_set, consensus_path in consensus_files.items():
        ...
        union_out_path = os.path.join(FEATURES_DIR, f"training_{feature_set}_UNION.csv")
        ...
        if stable_features:
            stable_out_path = os.path.join(FEATURES_DIR, f"training_{feature_set}_STABLE.csv")
